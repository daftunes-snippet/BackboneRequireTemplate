	...
	Templates['settings'] = [
		'<form role="form">',
			'<div class="form-group">',
				...
				'<input type="text" class="form-control" id="welcomeMessageInput" placeholder="Enter welcom message" value="<%= welcomeMessage %>"">',
			'</div>',
			'<div class="form-group">',
			...
			'<div class="form-group">',
				'<select id="tempType" class="form-control">',
					'<option value="fahr" <% console.log(celsius); if(!celsius) print(\"selected\") %>>Fahrenheit</option>',
